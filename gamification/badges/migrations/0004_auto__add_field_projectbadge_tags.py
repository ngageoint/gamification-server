...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProjectBadge.tags'
        db.add_column(u'badges_projectbadge', 'tags',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=400, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProjectBadge.tags'
        db.delete_column(u'badges_projectbadge', 'tags')
