...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Badge.icon'
        db.alter_column(u'badges_badge', 'icon', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))

    def backwards(self, orm):

        # Changing field 'Badge.icon'
        db.alter_column(u'badges_badge', 'icon', self.gf('django.db.models.fields.files.ImageField')(default='', max_length=100))
