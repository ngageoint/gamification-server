...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'core_team', 'parent',
                      self.gf('mptt.fields.TreeForeignKey')(blank=True, related_name='children', null=True, to=orm['core.Team']),
                      keep_default=False)

        # Adding field 'Team.lft'
        db.add_column(u'core_team', u'lft',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=None, db_index=True),
                      keep_default=False)

        # Adding field 'Team.rght'
        db.add_column(u'core_team', u'rght',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=None, db_index=True),
                      keep_default=False)

        # Adding field 'Team.tree_id'
        db.add_column(u'core_team', u'tree_id',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=None, db_index=True),
                      keep_default=False)

        # Adding field 'Team.level'
        db.add_column(u'core_team', u'level',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=None, db_index=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'core_team', 'parent_id')

        # Deleting field 'Team.lft'
        db.delete_column(u'core_team', u'lft')

        # Deleting field 'Team.rght'
        db.delete_column(u'core_team', u'rght')

        # Deleting field 'Team.tree_id'
        db.delete_column(u'core_team', u'tree_id')

        # Deleting field 'Team.level'
        db.delete_column(u'core_team', u'level')
    ...
    models = {
        ...
        u'core.team': {
            ...
            'parent': ('mptt.fields.TreeForeignKey', [], {'blank': 'True', 'related_name': "'children'", 'null': 'True', 'to': u"orm['core.Team']"}),
