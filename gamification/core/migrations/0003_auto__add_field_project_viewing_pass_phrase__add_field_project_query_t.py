...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Project.viewing_pass_phrase'
        db.add_column(u'core_project', 'viewing_pass_phrase',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Project.query_token'
        db.add_column(u'core_project', 'query_token',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Project.project_closing_date'
        db.add_column(u'core_project', 'project_closing_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Project.viewing_pass_phrase'
        db.delete_column(u'core_project', 'viewing_pass_phrase')

        # Deleting field 'Project.query_token'
        db.delete_column(u'core_project', 'query_token')

        # Deleting field 'Project.project_closing_date'
        db.delete_column(u'core_project', 'project_closing_date')
