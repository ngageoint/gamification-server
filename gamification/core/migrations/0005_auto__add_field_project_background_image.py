...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Project.background_image'
        db.add_column(u'core_project', 'background_image',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Project.background_image'
        db.delete_column(u'core_project', 'background_image')
